...
export default function PrivacyPage() {
  ...
  const sections = tr
    ? [
        ["Topladığımız veriler", "Hesap bilgilerin (e-posta, isteğe bağlı ad, ülke), tercihlerin ve Mizan'a eklediğin finansal veriler (yüklediğin ekstreler, eklediğin varlık/borçlar)."],
    ...
    : [
        ["What we collect", "Account details (email, optional name, country), your preferences, and the financial data you add to Mizan (statements you upload, assets/debts you enter)."],
    ...
    <main className="min-h-screen bg-canvas text-ink px-4 py-12">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-ink-mute text-xs mt-10">
          {tr ? "Veri talepleri için: " : "Data requests: "}<span className="text-ink-soft">privacy@mizan.app</span>
        </p>
      </div>
    </main>
  );
