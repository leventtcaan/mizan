...
export default function TermsPage() {
  ...
  const sections = tr
    ? [
        ["Hizmet", "Clarifin, finansal verilerini tek bir yerde toplaman ve anlamlandırman için bir araçtır. Bir banka, yatırım danışmanı veya muhasebeci değildir; sunulan içerik bilgilendirme amaçlıdır, yatırım tavsiyesi değildir."],
        ...
        ["Kabul edilebilir kullanım", "Clarifin'ı yasalara aykırı veya başkalarının haklarını ihlal eden şekilde kullanmamayı kabul edersin."],
        ["Sorumluluk", "Hizmet 'olduğu gibi' sunulur. Finansal kararların sorumluluğu sana aittir. Clarifin, dolaylı zararlardan sorumlu tutulamaz."],
        ["Değişiklikler", "Bu koşulları zaman zaman güncelleyebiliriz; önemli değişikliklerde seni bilgilendiririz."],
      ]
    : [
        ["The service", "Clarifin is a tool to bring your financial data together and make sense of it. It is not a bank, investment advisor, or accountant; content is informational and is not financial advice."],
        ...
        ["Acceptable use", "You agree not to use Clarifin for anything unlawful or that infringes the rights of others."],
        ["Liability", "The service is provided “as is”. You are responsible for your financial decisions. Clarifin is not liable for indirect damages."],
    ...
    <main className="min-h-screen bg-canvas text-ink px-4 py-12">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-ink-mute text-xs mt-10">
          {tr ? "Sorular için: " : "Questions: "}<span className="text-ink-soft">support@clarifin.app</span>
        </p>
      </div>
    </main>
  );
